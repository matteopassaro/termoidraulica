...
export default function Preventivo() {
  ...
  function onSubmit(values: z.infer<typeof preventivoSchema>) {
    console.log(values);
    toast({
  ...
  return (
    <Layout>
      <div className="bg-secondary/30 min-h-screen pb-20">
        {/* Header */}
        <div className="bg-primary text-white pt-20 pb-24 px-4 text-center">
          <div className="container mx-auto max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Richiedi un Preventivo</h1>
        ...
        <div className="container mx-auto px-4 md:px-6 -mt-10 relative z-10">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            {/* Form Section */}
            <div className="w-full lg:w-2/3 bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-border">
              <h2 className="text-2xl font-bold text-foreground mb-8">Dettagli Richiesta</h2>
            ...
            <div className="w-full lg:w-1/3 space-y-6">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-md border border-border">
                <h3 className="text-lg font-bold text-foreground mb-4">Hai un'urgenza?</h3>
                <p className="text-muted-foreground mb-6">
                  Se hai un tubo rotto, la caldaia bloccata o un allagamento, non aspettare l'email. Chiamaci subito.
                </p>
                <a href="tel:+390801234567" className="flex items-center justify-center gap-2 bg-red-50 text-red-600 hover:bg-red-100 font-bold py-4 rounded-xl transition-colors">
